...
import { Loader2, Brain, Mail, Lock, Eye, EyeOff, User } from "lucide-react";
...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // Step 1: Create user via admin API route (auto-confirms email)
      ...
      // Step 2: Sign in immediately (user is already email-confirmed)
      ...
      // Step 3: Redirect with full page load so middleware picks up cookies
