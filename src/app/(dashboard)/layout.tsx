...
const allNavigation = [
  ...
  { name: "Taches", href: "/tasks", icon: CheckSquare, roles: ["accountant", "payroll_manager", "firm_admin"] },
  { name: "Echeances", href: "/deadlines", icon: Calendar, roles: ["accountant", "payroll_manager", "firm_admin"] },
  { name: "Factures", href: "/invoices", icon: Receipt, roles: ["accountant", "firm_admin"] },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-[#0f0f1a] border-b border-gray-800 px-4 py-3 flex items-center justify-between">
        <button
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-72 bg-[#0f0f1a] border-r border-gray-800 z-50 transform transition-transform duration-300 ease-out lg:translate-x-0 ${
